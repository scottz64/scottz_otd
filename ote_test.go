...
func Test_ORD77_ORD78_10000TX_1ch_1ord_solo_batchSz(t *testing.T) {
        ...
        passResult, finalResultSummaryString := ote("ORD-77_ORD-78", 10000, 1, 1, "solo", 0, spyOff, 1 )
...
func Test_ORD96_50000TX_1ch_3ord_kafka_3kbs(t *testing.T) {
        ...
        passResult, finalResultSummaryString := ote("ORD-96", 50000, 1, 3, "kafka", 3, spyOff, 1 )
        if !passResult { t.Error(finalResultSummaryString) }
}
...
func Test_ORD97_500000TX_1ch_3ord_kafka_3kbs(t *testing.T) {
        ...
        passResult, finalResultSummaryString := ote("ORD-97", 500000, 1, 3, "kafka", 3, spyOff, 1 )
        if !passResult { t.Error(finalResultSummaryString) }
}
